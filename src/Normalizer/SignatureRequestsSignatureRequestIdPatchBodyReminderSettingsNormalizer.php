...
class SignatureRequestsSignatureRequestIdPatchBodyReminderSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'IIYousign\\Model\\SignatureRequestsSignatureRequestIdPatchBodyReminderSettings';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'IIYousign\\Model\\SignatureRequestsSignatureRequestIdPatchBodyReminderSettings';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \IIYousign\Model\SignatureRequestsSignatureRequestIdPatchBodyReminderSettings();
