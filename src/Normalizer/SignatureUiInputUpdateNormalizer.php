...
class SignatureUiInputUpdateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'IIYousign\\Model\\SignatureUiInputUpdate';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'IIYousign\\Model\\SignatureUiInputUpdate';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \IIYousign\Model\SignatureUiInputUpdate();
        ...
        if (\array_key_exists('fonts', $data) && $data['fonts'] !== null) {
            $values_2 = array();
            foreach ($data['fonts'] as $value_2) {
                $values_2[] = $value_2;
            }
            $object->setFonts($values_2);
        } elseif (\array_key_exists('fonts', $data) && $data['fonts'] === null) {
        ...
        if (\array_key_exists('redirectCancel', $data)) {
            $object->setRedirectCancel($this->denormalizer->denormalize($data['redirectCancel'], 'IIYousign\\Model\\SignatureUiInputUpdateRedirectCancel', 'json', $context));
        }
        if (\array_key_exists('redirectError', $data)) {
            $object->setRedirectError($this->denormalizer->denormalize($data['redirectError'], 'IIYousign\\Model\\SignatureUiInputUpdateRedirectError', 'json', $context));
        }
        if (\array_key_exists('redirectSuccess', $data)) {
            $object->setRedirectSuccess($this->denormalizer->denormalize($data['redirectSuccess'], 'IIYousign\\Model\\SignatureUiInputUpdateRedirectSuccess', 'json', $context));
        }
        return $object;
    }
    /**
