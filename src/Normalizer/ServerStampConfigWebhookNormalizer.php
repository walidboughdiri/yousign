...
class ServerStampConfigWebhookNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'IIYousign\\Model\\ServerStampConfigWebhook';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'IIYousign\\Model\\ServerStampConfigWebhook';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \IIYousign\Model\ServerStampConfigWebhook();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('server_stamp.finished', $data)) {
            $values = array();
