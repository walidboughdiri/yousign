...
class SignatureRequestSignerFromInfoInputRedirectUrlsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'IIYousign\\Model\\SignatureRequestSignerFromInfoInputRedirectUrls';
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'IIYousign\\Model\\SignatureRequestSignerFromInfoInputRedirectUrls';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \IIYousign\Model\SignatureRequestSignerFromInfoInputRedirectUrls();
